...
public class CookBookApiControllerTests {
	...
	@Test
	public void test_getAllIngredients_returns_list_of_all_ingredients_for_specific_recipe_by_id()
			throws ItemNotFoundException {
	...
	@Test
	public void test_getAllInstructionss_returns_list_of_all_instructions_for_specific_recipe_by_id()
			throws ItemNotFoundException {
	...
	@Test
	public void test_getOne_returns_Recipe_and_getOne_returns_Ingredient_and_add_adds_the_ingredient_to_the_recipe_and_save_updates_recipeRepo()
			throws ItemNotFoundException {
		// Arrange
	...
	@Test
	public void test_getOne_returns_Recipe_and_getOne_returns_Instruction_and_add_adds_the_instruction_to_the_recipe_and_save_updates_recipeRepo()
			throws ItemNotFoundException {
		// Arrange
		Recipe taco = new Recipe();
		Instructions stepOne = new Instructions();
